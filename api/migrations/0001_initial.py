# Generated by Django 4.2.3 on 2023-10-04 08:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('queue', models.IntegerField(verbose_name='Порядок')),
                ('description_1', models.TextField(blank=True, null=True, verbose_name='Описание до')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subtest', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subtest', to='api.subtest', verbose_name='Субтест')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Черновик', 'Черновик'), ('Опубликовано', 'Опубликовано')], default='Черновик', max_length=12, verbose_name='Статус интерпретации')),
