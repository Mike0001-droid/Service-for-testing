# Generated by Django 4.2.5 on 2023-11-18 06:14
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('Men', 'Men'), ('Women', 'Women'), ('Мужчина', 'Мужчина'), ('Женщина', 'Женщина')], default='MEN', max_length=7, verbose_name='Пол')),
                ('group', models.CharField(choices=[('Студент', 'Студент'), ('Преподаватель', 'Преподаватель')], default='Студент', max_length=13, verbose_name='Группа')),
